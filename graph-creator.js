function onHelp(itemid) {
  var elem = d3.select(itemid),
    txt = d3.select('#help_txt');

  elem.on('click', function (d, i) {
    elem.attr('class', elem.attr('class') === 'selected' ? '' : 'selected');
...
document.onload = (function (d3, saveAs, Blob, katex) {
  "use strict";
  ...
  graph.setIdCt(2);
  graph.updateGraph();
})(window.d3, window.saveAs, window.Blob, katex);
